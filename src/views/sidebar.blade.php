    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            <div class="pull-{{ cbLang('left') }} image">
                <img src="{{ CMS::myPhoto() }}" class="img-circle" alt="{{ cbLang('user_image') }}"/>
            </div>
        ...
        <div class='main-menu'>
            ...
            <ul class="sidebar-menu">
                ...
                <?php $dashboard = CMS::sidebarDashboard();?>
                @if($dashboard)
                    <li data-id='{{$dashboard->id}}' class="{{ (Request::is(config('cms.ADMIN_PATH'))) ? 'active' : '' }}"><a
                                href='{{CMS::adminPath()}}' class='{{($dashboard->color)?"text-".$dashboard->color:""}}'><i class='fa fa-dashboard'></i>
                            <span>{{cbLang("text_dashboard")}}</span> </a></li>
                @endif

                @foreach(CMS::sidebarMenu() as $menu)
                ...
                @if(CMS::isSuperadmin())
                    ...
                    <li class='treeview'>
                        ...
                        <ul class='treeview-menu'>
                            <li class="{{ (Request::is(config('cms.ADMIN_PATH').'/privileges/add*')) ? 'active' : '' }}"><a
                                        href='{{Route("PrivilegesControllerGetAdd")}}'>{{ $current_path }}<i class='fa fa-plus'></i>
                                    <span>{{ cbLang('Add_New_Privilege') }}</span></a></li>
                            <li class="{{ (Request::is(config('cms.ADMIN_PATH').'/privileges')) ? 'active' : '' }}"><a
                    ...
                    <li class="treeview">
                        <a href="#"><i class='fa fa-wrench'></i> <span>{{ cbLang('settings') }}</span> <i
                                    class="fa fa-angle-{{ cbLang("right") }} pull-{{ cbLang("right") }}"></i></a>
                        <ul class="treeview-menu">
                            <li class="{{ (Request::is(config('cms.ADMIN_PATH').'/settings/add*')) ? 'active' : '' }}"><a
                    ...
                    <li class='treeview'>
                        <a href='#'><i class='fa fa-th'></i> <span>{{ cbLang('Module_Generator') }}</span> <i
                                    class="fa fa-angle-{{ cbLang("right") }} pull-{{ cbLang("right") }}"></i></a>
                        <ul class='treeview-menu'>
                            <li class="{{ (Request::is(config('cms.ADMIN_PATH').'/module_generator/step1')) ? 'active' : '' }}"><a
                                        href='{{Route("ModulsControllerGetStep1")}}'><i class='fa fa-plus'></i>
                                    <span>{{ cbLang('Add_New_Module') }}</span></a></li>
                            <li class="{{ (Request::is(config('cms.ADMIN_PATH').'/module_generator')) ? 'active' : '' }}"><a
                    ...
                    <li class='treeview'>
                        <a href='#'><i class='fa fa-dashboard'></i> <span>{{ cbLang('Statistic_Builder') }}</span> <i
                                    class="fa fa-angle-{{ cbLang("right") }} pull-{{ cbLang("right") }}"></i></a>
                        <ul class='treeview-menu'>
                            <li class="{{ (Request::is(config('cms.ADMIN_PATH').'/statistic_builder/add')) ? 'active' : '' }}"><a
                                        href='{{Route("StatisticBuilderControllerGetAdd")}}'><i class='fa fa-plus'></i>
                                    <span>{{ cbLang('Add_New_Statistic') }}</span></a></li>
                            <li class="{{ (Request::is(config('cms.ADMIN_PATH').'/statistic_builder')) ? 'active' : '' }}"><a
                    ...
                    <li class='treeview'>
                        <a href='#'><i class='fa fa-fire'></i> <span>{{ cbLang('API_Generator') }}</span> <i
                                    class="fa fa-angle-{{ cbLang("right") }} pull-{{ cbLang("right") }}"></i></a>
                        <ul class='treeview-menu'>
                            <li class="{{ (Request::is(config('cms.ADMIN_PATH').'/api_generator/generator*')) ? 'active' : '' }}"><a
                                        href='{{Route("ApiCustomControllerGetGenerator")}}'><i class='fa fa-plus'></i>
                                    <span>{{ cbLang('Add_New_API') }}</span></a></li>
                            <li class="{{ (Request::is(config('cms.ADMIN_PATH').'/api_generator')) ? 'active' : '' }}"><a
                                        href='{{Route("ApiCustomControllerGetIndex")}}'><i class='fa fa-bars'></i>
                                    <span>{{ cbLang('list_API') }}</span></a></li>
                            <li class="{{ (Request::is(config('cms.ADMIN_PATH').'/api_generator/screet-key*')) ? 'active' : '' }}"><a
                    ...
                    <li class='treeview'>
                        <a href='#'><i class='fa fa-envelope-o'></i> <span>{{ cbLang('Email_Templates') }}</span> <i
                                    class="fa fa-angle-{{ cbLang("right") }} pull-{{ cbLang("right") }}"></i></a>
                        <ul class='treeview-menu'>
                            <li class="{{ (Request::is(config('cms.ADMIN_PATH').'/email_templates/add*')) ? 'active' : '' }}"><a
                                        href='{{Route("EmailTemplatesControllerGetAdd")}}'><i class='fa fa-plus'></i>
                                    <span>{{ cbLang('Add_New_Email') }}</span></a></li>
                            <li class="{{ (Request::is(config('cms.ADMIN_PATH').'/email_templates')) ? 'active' : '' }}"><a
                                        href='{{Route("EmailTemplatesControllerGetIndex")}}'><i class='fa fa-bars'></i>
                                    <span>{{ cbLang('List_Email_Template') }}</span></a></li>
                        </ul>
                    </li>

                    <li class="{{ (Request::is(config('cms.ADMIN_PATH').'/logs*')) ? 'active' : '' }}"><a href='{{Route("LogsControllerGetIndex")}}'><i
