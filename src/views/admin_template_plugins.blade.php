...
<script src="{{ asset ('vendor/cms/assets/adminlte/plugins/datepicker/bootstrap-datepicker.js') }}"></script>
<link rel="stylesheet" href="{{ asset ('vendor/cms/assets/adminlte/plugins/datepicker/datepicker3.css') }}">

<!--BOOTSTRAP DATERANGEPICKER 2.1.27 AND MOMENT 2.13.0 -->
<script src="{{ asset ('vendor/cms/assets/adminlte/plugins/daterangepicker/moment.min.js') }}"></script>
<script src="{{ asset ('vendor/cms/assets/adminlte/plugins/daterangepicker/daterangepicker.js') }}"></script>
<link rel="stylesheet" href="{{ asset ('vendor/cms/assets/adminlte/plugins/daterangepicker/daterangepicker-bs3.css') }}">

<!-- Bootstrap time Picker -->
<link rel="stylesheet" href="{{ asset ('vendor/cms/assets/adminlte/plugins/timepicker/bootstrap-timepicker.min.css') }}">
<script src="{{ asset ('vendor/cms/assets/adminlte/plugins/timepicker/bootstrap-timepicker.min.js') }}"></script>

<link rel='stylesheet' href='{{ asset("vendor/cms/assets/lightbox/dist/css/lightbox.min.css") }}'/>
<script src="{{ asset('vendor/cms/assets/lightbox/dist/js/lightbox.min.js') }}"></script>
...
<!--MONEY FORMAT-->
<script src="{{asset('vendor/cms/jquery.price_format.2.0.min.js')}}"></script>
...
<script>
    ...
    var ADMIN_PATH = '{{url(config("cms.ADMIN_PATH")) }}';
...
<script src="{{asset('vendor/cms/assets/js/main.js').'?r='.time()}}"></script>
